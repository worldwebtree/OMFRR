                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body text-capitalize">
                            ...
                            <form action="{{ route('admin.restaurant.management.store') }}" class="post_restaurant_form"
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-inverse">
                                    <thead class="thead-inverse text-capitalize">
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade UpdateRestaurantModel" id="" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body text-capitalize">
                                                        <form action="{{ route('admin.restaurant.management.update', ':id') }}" class="update_restaurant_form"
                                                            enctype="multipart/form-data"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            ...
                                                            <div class="form-title">
                                                                <h3>Update restaurant post</h3>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="RestaurantName">restaurant name</label>
                                                                <input type="text" name="restaurant_name" id="" class="form-control RestaurantName" required value="" placeholder="Enter name" aria-describedby="helpId">
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="custom-file">
                                                                    <input type="file"
                                                                            onchange="UpdateGetFileName(this)"
                                                                            multiple
                                                                            value=""
                                                                            name="restaurant_images[]"
                                                                            id=""
                                                                            class="custom-file-input RestaurantImages"
                                                                            accept="images/png,jpg"
                                                                            id="customInput">

                                                                    <label class="custom-file-label choose-file" 
                                                                        style="overflow: hidden !important;" 
                                                                        id="SecondfileInputLabel" 
                                                                        for="customInput">
                                                                        Choose file...
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="RestaurantDescription">restaurant description</label>
                                                                <textarea name="restaurant_description" id="secondEditor" cols="30" rows="10" class="form-control RestaurantDescription"></textarea>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="RestaurantCity">restaurant city</label>
                                                                <select class="form-control" name="restaurant_city" id="RestaurantCity">
                                                                    <option selected value="" class="selected_city"></option>
                                                                    <option value="Islamabad">Islamabad</option>
                                                                    <option value="" disabled>Punjab Cities</option>
                                                                    <option value="Ahmed Nager Chatha">Ahmed Nager Chatha</option>
                                                                    <option value="Ahmadpur East">Ahmadpur East</option>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="RestaurantAddress">restaurant address</label>
                                                                <input type="text" name="restaurant_address" id="" class="form-control RestaurantAddress" required value="" placeholder="Enter address" aria-describedby="helpId">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="RestaurantCategory">restaurant category</label>
                                                                <select class="form-control" name="restaurant_category" id="RestaurantCategory">
                                                                    <option selected value="" class="selected_category"></option>
                                                                    <option value="Dine In">Dine In</option>
                                                                    <option value="Take Away">Take Away</option>
                                                                </select>
                                                            </div>
...
<script type="text/javascript">
    ...
    function UpdateGetFileName(input) {
        ...
        var SecondInputLabel = $("#SecondfileInputLabel").text(names);

        $(SecondInputLabel).css("overflow", "hidden");
    }
    ...
    $(document).ready(function () {
        $(".UpdateUserBtn").click(function (e) { 
            ...
            let ReplacedImagesName = images.replace('[', '').replace(']', '');
            
            let Url = $(".update_restaurant_form").attr("action");
        
            let action = Url.replace(":id", id);

            $(".RestaurantName").val(title);
            // $(".RestaurantDescription").val(description);
            let textarea = $(".RestaurantDescription")
            textarea.value += description;
            $(".choose-file").text(ReplacedImagesName);
            $(".selected_city").text(city);
            $(".RestaurantAddress").val(address);
            $(".selected_category").text(category);

            $(".UpdateRestaurantModel").modal('show');
        });
    });
</script>
@endpush
